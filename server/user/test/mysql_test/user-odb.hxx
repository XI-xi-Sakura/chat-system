...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::bite_im::User >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::bite_im::User >
  {
    public:
    typedef ::bite_im::User object_type;
    typedef ::bite_im::User* pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::bite_im::User, id_mysql, A >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::id_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::user_id_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  user_id (A::table_name, "`user_id`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::nickname_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  nickname (A::table_name, "`nickname`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::description_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  description (A::table_name, "`description`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::password_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  password (A::table_name, "`password`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::phone_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  phone (A::table_name, "`phone`", 0);

  template <typename A>
  const typename query_columns< ::bite_im::User, id_mysql, A >::avatar_id_type_
  query_columns< ::bite_im::User, id_mysql, A >::
  avatar_id (A::table_name, "`avatar_id`", 0);

  template <typename A>
  struct pointer_query_columns< ::bite_im::User, id_mysql, A >:
    query_columns< ::bite_im::User, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::bite_im::User, id_mysql >:
    public access::object_traits< ::bite_im::User >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::bite_im::User, id_common >:
    public access::object_traits_impl< ::bite_im::User, id_mysql >
  {
  };
