...
namespace odb
{
  ...
  struct access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::id_type
  access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
  ...
  bool access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::find_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::update_statement[] =
  ...
  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::erase_statement[] =
  "DELETE FROM `chat_session_member` "
  "WHERE `id`=?";

  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::query_statement[] =
  "SELECT "
  "`chat_session_member`.`id`, "
  "`chat_session_member`.`session_id`, "
  "`chat_session_member`.`user_id` "
  ...
  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::erase_query_statement[] =
  "DELETE FROM `chat_session_member`";

  const char access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::table_name[] =
  "`chat_session_member`";
  ...
  access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::pointer_type
  access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
  ...
  result< access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::object_type >
  access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::bite_im::ChatSessionMember, id_mysql >::
